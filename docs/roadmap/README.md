...
| R008 | now | active | Closure risk review | B008, R006, R007, active spec `021-closure-risk-review` | Closure readiness can incorporate validation-plan and evidence-quality signals before a package is removed. | platform | `docs/specs/021-closure-risk-review/` |
