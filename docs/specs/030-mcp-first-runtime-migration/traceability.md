...
| T013 | Requirement 1; Requirement 5; Requirement 6; Requirement 8; Requirement 9 | R1 AC1-AC2; R5 AC3-AC4; R6 AC3; R8 AC2; R9 AC3 | `design.md#operational-considerations`; `design.md#migration-and-compatibility` | none | `verification.md#durable-doc-promotion` | `docs/reference/spec-lifecycle-runtime.md`; `docs/reference/spec-lifecycle-manager-mcp-install.md`; `skills/spec-lifecycle-manager/SKILL.md` | none |
