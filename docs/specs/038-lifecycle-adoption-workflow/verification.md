...
| `PYTHONDONTWRITEBYTECODE=1 python3 -m unittest discover -s tests -p 'test_*.py'` | Full regression suite | passed | All 318 tests passed after capability-status and initialization-retention coverage was added |
