...
| --- | --- | --- | --- | --- | --- | --- | --- |
| T001 | Requirement 1, Requirement 6 | All | Task State Contract, Open Questions | Skill/runtime docs | Docs review | `skills/spec-lifecycle-manager/SKILL.md`, `docs/reference/spec-lifecycle-runtime.md` | Marker semantics |
...
| T004 | Requirement 2 | All | Task List Tool, Task Detail Tool | Runtime helpers | Unit tests | `skills/spec-lifecycle-manager/scripts/spec_runtime.py` | none |
...
| T007 | Requirement 3 | All | Task State Update Tool, Write-Tool Guardrails | Write helper | Runtime tests | `skills/spec-lifecycle-manager/scripts/spec_runtime.py` | MCP write permission policy |
| T008 | Requirement 2, Requirement 3, Requirement 4, Requirement 5 | All | Hook Behavior, Write-Tool Guardrails | MCP and hooks | Runtime/MCP/hook tests | MCP server, hook wrapper | MCP write permission policy |
...
| Requirement 2 | 1-7 | Task List Tool, Task Detail Tool | T004, T005, T010 | Runtime and MCP tests | Runtime and MCP server |
| Requirement 3 | 1-8 | Task State Update Tool, Write-Tool Guardrails | T006, T007, T008 | Runtime and MCP tests | Runtime and MCP server |
| Requirement 4 | 1-6 | Task Audit Tool, Reconciliation Classifications, Evidence Depth | T006, T010 | Runtime fixture tests | Runtime and traceability lookup |
| Requirement 5 | 1-5 | Hook Behavior | T006, T008 | Hook tests | Runtime hooks |
| Requirement 6 | 1-5 | Operational Considerations | T001, T009 | Docs/template review | Skill docs and templates |
...
| Write-Tool Guardrails | Requirement 3 | T007, T008 | Runtime and MCP server | Runtime/MCP tests |
