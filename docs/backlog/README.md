...
| B026 | done | Distribution packaging for GHCR | User request | Added a GHCR-ready package contract, Containerfile layout, provenance metadata, package-contract validation, and install docs. Publishing, registry authentication, and direct GHCR install remain future work. |
