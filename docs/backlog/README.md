...
| B064 | active     | Lifecycle adoption workflow                              | Qualified bounded Chat Analyser findings from 2026-07-18; B014, B015, B025; active spec `038-lifecycle-adoption-workflow`                                                          | Add a declarative read-only implementation-start workflow, strengthen evidence and durable-promotion routing, make MCP-primary recovery guidance effective, reduce source skill size by at least 30% while preserving mandatory rules, and remove full-package lint execution and advice from ordinary write hooks while retaining explicit resume, closure, and direct-validation boundaries. Consume only a reviewed qualified external dogfood report. Keep Spec 034 phase-completion mutation, Chat Analyser analysis contracts and repairs, and B025 emitted telemetry outside this slice. |
