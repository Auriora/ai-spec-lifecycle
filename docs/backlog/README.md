...
| B049 | active | Guided documentation wizard | User request for step-by-step documentation, feedback, and open-question guidance; active spec `026-guided-documentation-wizard` | Prompt-only v1 adds a preview-first guided workflow that asks stage-specific questions, classifies open questions and feedback, and composes existing lifecycle-guide, stage-readiness, prompt, and task-context surfaces instead of creating a second lifecycle engine. |
