...
| B026 | done | npm distribution packaging | User request | Added npm package metadata, an `npx @auriora/spec-lifecycle-manager install` wrapper, package-contract validation, npm pack dry-run coverage, and install docs. npm publish, registry authentication, and release automation remain future work. |
