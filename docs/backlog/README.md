...
| B031 | active     | Phase gate check                                         | Kiro requirements-design-tasks-implementation workflow review; lifecycle runtime; active spec `033-phase-gate-check`                                                        | Promoted to `docs/specs/033-phase-gate-check/` in wizard requirements mode. Add a deterministic phase-gate check that reports whether a spec is ready to move from requirements to design, design to tasks, tasks to implementation, or implementation to promotion and closure. See Kiro-inspired candidate details.                                                                                                                                                                                                                                                                                                                                                                                                                |
